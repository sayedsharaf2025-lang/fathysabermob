  ...
  if (ctx1) {
    ...
    paymentChartInstance = new Chart(ctx1, {
      ...
      data: {
        ...
        datasets: [{ label: 'المدفوعات', data: payValues, borderColor: '#27ae60', backgroundColor: 'rgba(39,174,96,0.1)', tension: 0.4, fill: true }]
      },
      options: { responsive: true, plugins: { legend: { display: true, position: 'top', rtl: true } }, scales: { y: { beginAtZero: true } } }
    });
  }
